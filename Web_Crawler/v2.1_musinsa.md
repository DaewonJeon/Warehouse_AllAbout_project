멋진 프로젝트 완성을 축하드립니다! 👏
지금까지 진행한 **[수집 - 적재 - 검색 API - 프론트엔드]**의 전 과정을 담아, 포트폴리오로 제출해도 손색없을 수준의 **GitHub `README.md**` 초안을 작성해 드립니다.

이 내용을 그대로 복사해서 `README.md` 파일에 붙여넣으시면 됩니다.
...
flowchart LR
    ...
    C <-->|Search Query| D[FastAPI Server]
